...
-- ═══ 单词插图标记（2026-09-21 补）═══════════════════════════════════════════
-- public/images/words/ 下有 {汉字}.jpg 的词才标记 has_image；
-- image_path 用相对路径（无开头斜杠），本地与 GitHub Pages 子路径都能解析。
-- 幂等：可重复执行。新增图片时把汉字加进列表即可。

update public.words
set has_image = true, image_path = 'images/words/' || hanzi || '.jpg'
where hanzi in (
  '丈夫','上班','下雨','中国','书','买','人','休息',
  '儿子','先生','公共汽车','公司','写','冷','出租车','北京',
  '医生','医院','卖','吃','同学','听','咖啡','哥哥',
  '唱歌','商店','喝','坐','天气','女','女儿','好吃',
  '妈妈','妹妹','妻子','姐姐','字','学习','学校','学生',
  '孩子','家','宾馆','工作','帮助','弟弟','快','慢',
  '房间','手机','手表','打电话','打篮球','报纸','教室','旅游',
  '早上','晚上','晴','月','朋友','服务员','机场','杯子',
  '桌子','椅子','水','水果','洗','游泳','火车站','热',
  '爸爸','牛奶','狗','猫','玩','生日','生病','电影',
  '电脑','电视','男','白','眼睛','睡觉','票','穿',
  '笑','等','米饭','累','红','给','羊肉','老师',
  '考试','苹果','茶','药','菜','衣服','西瓜','说',
  '说话','读','走','起床','跑步','路','跳舞','踢足球',
  '身体','运动','送','钱','铅笔','长','门','问',
  '阴','雪','面条儿','颜色','飞机','饭店','高','鱼',
  '鸡蛋','黑'
);
